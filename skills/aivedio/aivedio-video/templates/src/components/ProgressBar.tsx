...
interface Props {
   ...
   * with the chapter list on hover. Pass a URL to show it, `null`/omit to
   * hide it.
   */
 ...
 *
 * An optional GitHub link sits to the right of the viewport, sharing the
 * same hover trigger so it appears/disappears in sync with the bar.
 * Omit `githubUrl` to hide it.
 */
